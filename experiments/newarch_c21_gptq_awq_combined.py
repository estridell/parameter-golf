#!/usr/bin/env python3
"""
Newarch GPTQ+AWQ Combined (C21 adapted)
=========================================
...
def log(msg):
    print(f"[NEWARCH-C21] {msg}", flush=True)
...
def main():
    ...
    results = {
        "experiment": "NEWARCH_C21_GPTQ_AWQ_Combined",
    ...
    with open("experiments/newarch_c21_results.json", "w") as f:
        json.dump(results, f, indent=2)
    log("Results saved to experiments/newarch_c21_results.json")
